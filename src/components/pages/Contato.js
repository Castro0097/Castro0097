    ...
    <div id="contato">
      ...
      <h3>
        <div id="texto">
          ...
          experiência satisfatória. Caso necessite de mais informações entre em
          contato conosco. Nosso escritório está localizado à
          <strong>
            {" "}
            <strong>
              Rua Francisco dos Santos nº 28, sala 02, Centro - Araxá-MG - CEP:
              38.183.238{" "}
            </strong>
          </strong>{" "}
          ...
          <div id="flexC">
            <div id="telefone">
              <img alt="Telefone" src={Phone}></img>
            </div>
            <br></br>
            <br></br>
            <div>
              <strong>(34)-3664-6461</strong>
            </div>
          </div>
          <Iframe
